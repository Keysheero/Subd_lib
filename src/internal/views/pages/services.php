...
<section>
    <div class="advice-section">
        <h2>Advices</h2>
        <ul>
            <li><img src="../../../public/assets/img/service/contract.png" alt="Icon" class="icon"> Keep a copy of the contract</li>
            <li><img src="../../../public/assets/img/service/defining.png" alt="Icon" class="icon"> Clearly define your goals</li>
            <li><img src="../../../public/assets/img/service/vulnerability.png" alt="Icon" class="icon"> Check for hidden clauses:</li>
        </ul>
    </div>
</section>
